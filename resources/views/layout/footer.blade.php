    <div class="bg-white py-16">
        <div class="flex justify-between px-20">
            <div class="font-nunito space-y-2">
                <a href="/" class="font-bold text-2xl font-raleway">GoStorage</a>
                <div class="w-4/6">Jl. Soekarno Hatta, Bandung, Jawa Barat</div>
                <div class="">+62878253688881</div>
            ...
            <div class="flex space-x-16 pr-10">
                ...
                <div>
                    ...
                    <div class="space-y-1 font-nunito">
                        <div>
                            <a href="" class="hover:underline">Cari Gudang</a>
                        </div>
                        <div>
