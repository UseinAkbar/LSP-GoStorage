...
<div class="flex">
    ...
    <div class="px-5 w-10/12">
        ...
        <div class="mt-7 font-bold text-3xl">Edit Data Pelanggan</div>
        <form action="{{route('dashboard.admin_put', $data['id'])}}" method="post" class="mt-5" enctype="multipart/form-data">
            ...
            <div class="flex flex-col w-1/2">
                ...
                <div class="mt-2 w-full space-y-2">
                    ...
                    <input type="text" value="{{old('noTelp', $data['noTelp'])}}" name="noTelp" class="border border-black px-3 py-2 w-full" placeholder="Nomor Telepon">
                </div>
                <div class="mt-2 w-full space-y-2">
                    <div class="">Instansi</div>
                    <input type="text" value="{{old('instansi', $data['instansi'])}}" name="instansi" class="border border-black px-3 py-2 w-full" placeholder="Instansi">
                </div>
                <button type="submit">
