...
<div class="flex">
    ...
    <div class="px-5 w-10/12">
        <div class="mt-7 font-bold text-3xl">Edit Gudang</div>
        @if (count($errors) > 0)
      ...
      @endif
        ...
        @endif
        <form action="{{route('dashboard.gudang_put', $data['id'])}}" method="post" class="mt-5" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="flex flex-col w-1/2">
                <div class="mt-2 w-full space-y-2">
                    ...
                    <input type="text" value="{{old('nama_gudang', $data['nama_gudang'])}}" name="nama_gudang" class="border border-black px-3 py-2 w-full" placeholder="Nama Gudang">
                </div>
                <div class="mt-2 w-full space-y-2">
                    <div class="">Kode Gudang</div>
                    <input type="text" name="kode_gudang" value="{{old('kode_gudang', $data['kode_gudang'])}}" class="border border-black px-3 py-2 w-full" placeholder="Kode Gudang">
                </div>
                <div class="mt-2 w-full space-y-2">
                    <div class="">Lokasi</div>
                    <input type="text" name="lokasi" value="{{old('lokasi', $data['lokasi'])}}" class="border border-black px-3 py-2 w-full" placeholder="Lokasi Gudang">
                </div>
                <div class="mt-2 w-full space-y-2">
                    <div class="">Luas</div>
                    <input type="text" name="luas" value="{{old('luas',  $data['luas'])}}" class="border border-black px-3 py-2 w-full" placeholder="Luas Gudang (m2)">
                </div>
                <div class="mt-2 w-full space-y-2">
                    <div class="">Harga</div>
                    <input type="text" name="harga" value="{{old('harga', $data['harga'])}}" class="border border-black px-3 py-2 w-full" placeholder="Harga Sewa Gudang">
                </div>
                <div class="mt-2 w-full space-y-2">
                ...
                <div class="mt-2 w-full space-y-2">
                    ...
                    <textarea name="deskripsi" class="border border-black px-3 py-2 w-full" placeholder="Deskripsi Gudang">{{old('deskripsi', $data['deskripsi'])}}</textarea>
                </div>
                <div class="mt-2 w-full space-y-2">
                    <div class="">Gambar</div>
                    <input name="gambar" type="file" value="{{old('gambar')}}" class="border border-black px-3 py-2 w-full">
                </div>
                <button>
                <button type="submit">
